/*
  ...
  scheduleArray = [
    [null,       10:00 day1,    10:30 day1,   11:00 day1 ... 5:00 day1,   10:00 day2,   10:30 day2,   11:00 day2 ... 5:00 day2]
    [Student 1,      -,            -,            -,            +,              +,            +,            +,            +    ]
    [Student 2,      +,            +,            -,            +,              -,            -,            +,            +    ]     
    [Student 3,      +,            -,            +,            +,              +,            +,            +,            +    ]
    [Student 4,      +,            +,            +,            +,              +,            +,            -,            +    ]
...
const numberOfTimeSlotsDay = numberOfTimeSlotsTotal/2;
...
const timePeriods = ["10:00AM Day 1", "10:30AM Day 1", "11:00AM Day 1", "11:30AM Day 1", "12:00PM Day 1", "12:30PM Day 1", "1:00PM Day 1", "1:30PM Day 1", "2:00PM Day 1", "2:30PM Day 1", "3:00PM Day 1", "3:30PM Day 1", "4:00PM Day 1", "4:30PM Day 1",
                     "10:00AM Day 2", "10:30AM Day 2", "11:00AM Day 2", "11:30AM Day 2", "12:00PM Day 2", "12:30PM Day 2", "1:00PM Day 2", "1:30PM Day 2", "2:00PM Day 2", "2:30PM Day 2", "3:00PM Day 2", "3:30PM Day 2", "4:00PM Day 2", "4:30PM Day 2"
];

//Two interview dates
var firstDay = new Date("4/8/2021");
firstDay = Utilities.formatDate(firstDay, "GMT", "EEEE, MMMM d, yyyy");

var secondDay = new Date("4/9/2021");
...
/*
  ...
  If you check the box manually, you will triger onEdit() function, which will call errorDataCheckOnEdit() function which will check for any conflicts/errors on the sheet schedule
...
var algoResultCheck = sheet.getRange("Q100:T100");
...
const firstNamesRangeDay1 = sheet.getRange("A3:A46");
const lastNamesRangeDay1 = sheet.getRange("B3:B46");

const firstNamesRangeDay2 = sheet.getRange("A51:A94");

//Array of companies and its range
const companiesRange = sheet.getRange("C100:C119").getValues();
var companiesArray = [];
...
//Company Email Range
const companyEmailRange = sheet.getRange("R51:R52");

//Student Emails Range
const studentEmailsRange = sheet.getRange("R3:R4");

//If you want to fill PODs randomly, set it to True
const fillPods = true;

//Range for the POD 1
const pod1Range = sheet.getRange("D100:K106");
//const pod1Range = sheet.getRange("D100:I106");

//Range for the POD 2
const pod2Range = sheet.getRange("D107:K113");
//const pod2Range = sheet.getRange("D107:I113");

//Range for the POD 3
const pod3Range = sheet.getRange("D114:K119");
//const pod3Range = sheet.getRange("D114:I119");

//Range for all PODs all together
const allPodsRange = sheet.getRange("D100:K119");
//const allPodsRange = sheet.getRange("D100:I119");
...
const studentEmailText = "Katherine Chuang, thank you for your time and patience, it was nice to have a Data Structures class with you, good luck!\n\n";

const companyEmailText = "Allan James Lapid, thank you for your time and patience, it was nice to work with you, good luck!\n\n";
...
/*
  ...
  This function makes it possible to have 2 pods with 15 student and one pod with 14 students. So, it does not matter how many students/poods you have. The algorithm would work perfectly with any numbers.
*/
...
/*
  ...
  This function will not let algorithm fill the time slot if that would create a conflict/error in the schedule.
*/
    ...
    for (var timeSlots = 1; timeSlots <= numberOfTimeSlotsTotal; timeSlots++)
    {
      if (schedulingArray[studentCount][timeSlots].length > 1)
      {
        if (schedulingArray[0][timeSlots].includes("Day 1") == true)
        {
          ...
          studentSchedule += schedulingArray[studentCount][timeSlots] + "\n\n";
        }
      ...
      for (var timeSlots = 1; timeSlots <= numberOfTimeSlotsTotal; timeSlots++)
      {
        if (schedulingArray[studentCount][timeSlots] == companiesArray[companyCount])
        {
          if (schedulingArray[0][timeSlots].includes("Day 1") == true)
          {
            ...
            companySchedule += schedulingArray[studentCount][0] + "\n\n";
          }
          else if (schedulingArray[0][timeSlots].includes("Day 2") == true)
          {
